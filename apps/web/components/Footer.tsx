...
export function Footer() {
  ...
  return (
    <footer className="mx-auto flex w-full max-w-6xl flex-col items-center gap-3 border-t border-[var(--border)] px-6 py-7 text-sm text-[var(--text-3)] sm:flex-row sm:justify-between">
